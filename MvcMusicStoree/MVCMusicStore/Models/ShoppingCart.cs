...
namespace MvcMusicStore.Models
{
    public partial class ShoppingCart 
    {
        ...
        public void AddToCart(Album album)
        {
           ...
           var cartItem = _context.Carts?.FirstOrDefault(c => c.CartId == ShoppingCartId  && c.AlbumId == album.AlbumId);
...
&& cart.RecordId == id);
        ...
        {
            return _context.Carts.Include(c => c.Album).Where(cart => cart.CartId == ShoppingCartId).ToList();
        }
